...
## Create a GitHub [Issue](https://github.com/Aaditya1273/RiskRaider/issues) and **then** a pull request

Start contributing by first [opening a new issue](https://github.com/Aaditya1273/RiskRaider/issues/new/choose). Once that is done, you can create a pull request for the issue.

## License

Your submissions are understood to be under the same [Apache License 2.0](https://github.com/Aaditya1273/RiskRaider/blob/main/LICENSE.md) that covers the project.
